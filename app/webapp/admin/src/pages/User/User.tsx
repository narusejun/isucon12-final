...
import { adminBanUser, adminGetUser, adminGetUserResponse, errorResponse } from "../../services/admin";
...
const User = ({ sessionId, handleSetSessionId }: userPageProps) => {
  ...
  const handleSelectChante = (e: { target: HTMLSelectElement }) => {
    const { name, value } = e.target;
    setInputValue({ ...inputValue, [name]: value });
  };
  ...
  return (
    <>
      ...
      <div style={{ padding: "10px" }}>
        ...
        <div>
          <InputSelect name="data" value={inputValue.data} handleChange={handleSelectChante} style={{ width: "300px" }}>
            ...
            <InputOption value="userPresentAllReceivedHistroy">user present all received histroy</InputOption>
          </InputSelect>
        </div>
      </div>
      ...
      <div style={{ padding: "10px" }}>
        {isLoading ? (
          ...
          <>
            ...
            {inputValue.data === "userPresentAllReceivedHistroy" &&
